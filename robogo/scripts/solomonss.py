...
def move_in_line_slowly(side_length,vel_msg,pub):
...
if __name__ == '__main__':
	try:
		# global speed
		rospy.init_node('move_solomon',anonymous = True)
		pub = rospy.Publisher('/turtle1/cmd_vel',Twist, queue_size = 10)
		vel_msg = Twist()
		rr = rospy.Rate(100)

		move_in_line(3,vel_msg, pub)
		rotate(vel_msg,pub, 2*PI/3)
		move_in_line(3,vel_msg, pub)
		rotate(vel_msg,pub, 2*PI/3)
		move_in_line(3, vel_msg, pub)
		rotate(vel_msg,pub, PI)
		move_in_line(1, vel_msg, pub)
		rotate(vel_msg,pub, PI/3)
		move_in_line(1, vel_msg, pub)
		rotate(vel_msg,pub, PI)
		move_in_line(3, vel_msg, pub)
		rotate(vel_msg,pub, 2*PI/3)
